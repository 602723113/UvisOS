...
public class QRCodeUtils {
     ...
     */
    public static File createCodeToFile(String codeContent, File codeImgFileSaveDir, String fileName) {
        try {
            /** 参数检验*/
     ...
     * @throws Exception
     */
    public static String parseQRCodeByBytes(byte[] bytes) {
        String resultStr = "null";
        if (bytes == null) {
            return resultStr;
        }
